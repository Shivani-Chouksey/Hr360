...
import { EmployeeDetails } from '../../../shared/components/employee/employee-details/employee-details';
...
import { EmployeeForm } from "../../../shared/components/employee/employee-form/employee-form";
...
@Component({
  ...
  imports: [NgClass, BasicTable, NgIf, EmployeeDetails, AsyncPipe, MatIcon, ReactiveFormsModule, EmployeeForm, MatTabsModule],
